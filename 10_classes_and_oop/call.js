...
function createUser(username, email, password) {
    ...
    SetUsername.call(username); //yha bhi same problem hai...variable hold nahi hoga. par function call to hoga. 
    ...
    // 
    // Bhale hee call humne execution context ke andar kiya hai par still ye problem aati hai. 
